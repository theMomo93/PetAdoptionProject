  ...
  <div className='container-resources text-center'>
    ...
    <ol>
      <div className="column-one">
        ...
        <li><span>Research and Educate Yourself:</span> Learn about the specific needs, behaviors, and potential health issues of the animal you're interested in. Being informed will aid in providing proper care and understanding their unique traits.</li>
        ...
        <li><span>Complete a Thorough Adoption Process:</span> Cooperate fully with the shelter's adoption process. This may include interviews, home visits, and paperwork. A comprehensive process ensures that the animal is going to a suitable and caring home.</li>
      </div>
